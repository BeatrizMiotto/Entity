...
namespace Entity.Controllers
{
    public class ConfiguracoesController : Controller
    {
        ...
        public ConfiguracoesController(BaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Configuracoes != null ? 
                          ...
                          Problem("Entity set 'BaseContext.Configuracoes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BaseContext.Configuracoes'  is null.");
            }
            var configuracao = await _context.Configuracoes.FindAsync(id);
            if (configuracao != null)
            {
